    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [{ path: "managers", element: <ManagersPage /> }],
          },
          {
          ...
          {
            // O'qituvchilar va Admin/Managerlar uchun davomat sahifasi
            element: (
              <RoleGuard allowedRoles={["TEACHER", "ADMIN", "MANAGER"]} />
            ),
            children: [
              {
                path: "attendance",
    ...
    element: (
      <div className="h-screen flex flex-col items-center justify-center bg-background text-center p-4">
        ...
        <p className="text-text-muted max-w-sm">
          Sizning profilingiz orqali ushbu sahifaga kirish taqiqlangan!
        </p>
        <a
          href="/dashboard"
